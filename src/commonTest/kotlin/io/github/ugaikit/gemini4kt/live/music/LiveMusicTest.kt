...
class LiveMusicTest {
    ...
    @Test
    fun testSetWeightedPromptsSendsCorrectJSON() = runTest {
    ...
    @Test
    fun testSetMusicGenerationConfigSendsCorrectJSON() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testPlaySendsCorrectJSON() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testPauseSendsCorrectJSON() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testStopSendsCorrectJSON() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testResetContextSendsCorrectJSON() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testReceiveGetsMessagesFromChannel() = runTest {
        val mockSession = MockWebSocketSession()
    ...
    @Test
    fun testReceiveAudioChunk() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>(1)
        val session = LiveMusicSession(
            session = mockSession,
    ...
    @Test
    fun testCloseClosesSessionAndChannel() = runTest {
        val mockSession = MockWebSocketSession()
        val incoming = Channel<LiveMusicServerMessage>()
        val job = Job()
        val session = LiveMusicSession(
